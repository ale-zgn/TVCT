import { View, Text, ScrollView, StyleSheet, StatusBar, FlatList, Image, Pressable } from "react-native"
import React, { useEffect, useState } from "react"
import { heightPercentageToDP as hp, widthPercentageToDP as wp } from "react-native-responsive-screen"
import { LeftArrowIcon, LocationIcon, RightArrowIcon } from "../../../assets/svgs/Svg"
...
export default function Property({ property }) {
    ...
    return (
        <Pressable
            ...
            onPress={() => {
                //@ts-ignore
                navigation.navigate("MyPropertiesDetails", { property_id: property.id })
            }}
        >
            <ImageBackground
                placeholder={{
