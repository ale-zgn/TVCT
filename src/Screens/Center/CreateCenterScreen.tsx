...
import { useCreateCenterMutation, useLazyGetAddressPredictionsQuery } from 'src/Services/API'
...
export default function CreateCenterPage() {
    ...
    const [createCenter, createCenterMutation] = useCreateCenterMutation()
    ...
    const onSubmit = async (data: any) => {
        try {
            ...
            await createCenter({
                availability_start_date: fromTime,
                availability_end_date: toTime,
                address: data.city,
        ...
        <KeyboardAwareScrollView
            ...
            <ScrollView contentContainerStyle={styles.container}>
                ...
                <View style={styles.inputsContainer}>
                    ...
                    <TouchableOpacity onPress={() => showTimePicker('from')} style={styles.timePickerBox}>
                        <Text style={styles.timeText}>{fromTime ? moment(fromTime).locale('en').format('HH:mm') : translate('Select time')}</Text>
                    </TouchableOpacity>
                </View>
                ...
                <View style={styles.inputsContainer}>
                    ...
                    <TouchableOpacity onPress={() => showTimePicker('to')} style={styles.timePickerBox}>
                        <Text style={styles.timeText}>{toTime ? moment(toTime).locale('en').format('HH:mm') : translate('Select time')}</Text>
                    </TouchableOpacity>
                </View>
                ...
                {/* Time Picker Modal */}
                <DateTimePickerModal isVisible={isPickerVisible} mode='time' onConfirm={handleConfirm} onCancel={() => setPickerVisible(false)} />
                ...
                <MaintButton
                    ...
                    bottom
                    hasActivityIndicator={createCenterMutation.isLoading}
                />
            </ScrollView>
        </KeyboardAwareScrollView>
    )
