...
const DriveInformations: {
  ...
  },
  {
    ...
    content:
      "Access detailed reports, set reminders, and book inspection appointments — all in one place, wherever you are.",
    icon: PossibilitiesIcon,
  },
  {
    title: "Drive with Confidence",
    content:
      "Ensure your vehicle meets all safety and legal standards with certified inspections, helping you stay compliant and safe on the road.",
      ...
      if (token) {
        try {
          ...
          if (
            ...
            decoded.iat &&
            decoded.user_id &&
            moment(decoded.iat * 1000).isBefore(moment("2024-05-05")) &&
            decoded.user_id == 902
          ) {
    ...
    <Pressable style={styles.serviceWrapper} onPress={service.onPress}>
      <View
        style={[
          ...
          { borderColor: service.backgroundColor },
        ]}
      >
        {service.icon}
      </View>
