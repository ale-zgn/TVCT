            ...
            <ScrollView contentContainerStyle={styles.container}>
                <View style={styles.sectionContainer}>
                    ...
                    {pickerValue && conditionalFields[pickerValue] && (
                        <View>
                            <Text style={styles.sectionTitle}>{translate('Informations spécifiques')}</Text>
                ...
                {pickerValue && (
                    <>
                        <MaintButton
                            ...
                            textColor='white'
                        />
                        <View style={{ height: 1, width: wp('90%'), backgroundColor: 'grey', marginBottom: hp('2%'), alignSelf: 'center' }}></View>
