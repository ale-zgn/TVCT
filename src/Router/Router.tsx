...
export default function Router() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      Asset.fromModule(
        require("../../assets/images/TUTO..1.png")
      ).downloadAsync(),
      Asset.fromModule(
        require("../../assets/images/TUTO..2.png")
      ).downloadAsync(),
      Asset.fromModule(
        require("../../assets/images/PAYEMENT.png")
      ).downloadAsync(),
      Asset.fromModule(
        require("../../assets/images/TUTTO.4.png")
      ).downloadAsync(),
  ...
  useEffect(() => {
    if (navigationRef.current !== null && navigationScreen.route !== "") {
      ...
      navigationRef.current.navigate(
        isAuth ? "TabNavigator" : "TabNavigatorUnlogged"
      );
  ...
  return (
    <>
      <View
        ...
        style={[
          selectedLanguage === "en" ? styles.ltr : styles.rtl,
          { flex: 1 },
        ]}
      >
        ...
        >
          <RootStack.Navigator
            ...
            initialRouteName={isAuth ? "TabNavigator" : "TabNavigatorUnlogged"}
          >
            <RootStack.Screen
              name="LoginStack"
              component={LoginUnloggedStackScreen}
            />

            <RootStack.Screen
              name="TabNavigatorUnlogged"
              component={TabNavigatorUnlogged}
            />
